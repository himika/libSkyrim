...
/*==============================================================================
class NiSkinInstance +0000 (_vtbl=010C4ED4)
0000: class NiSkinInstance
0000: |   class NiObject
...
{
public:
	//// @override class NiObject : (vtbl=010C4ED4)
	//virtual ????   Unk_000(????) override;                           // 005EBF30
	//virtual UInt32 Unk_002(void) override;                           // 005EBF20 { return 0x01B927B8; }
	//virtual ????   Unk_013(????) override;                           // 00AD2CD0
	//virtual ????   Unk_014(????) override;                           // 00AD2390
	//virtual ????   Unk_015(????) override;                           // 00AD2840
	//virtual ????   Unk_016(????) override;                           // 00AD2550
	//virtual ????   Unk_017(????) override;                           // 00AD2A30
	//virtual ????   Unk_018(????) override;                           // 00AD25C0
	//virtual void   Unk_01A(UInt32 arg) override;                     // 00AD23C0 { return; }

	// @add
	virtual void	Unk_21(void);			// 00AD2690

	// @members
	//void				** _vtbl;			// 00 - 010C4ED4
...
/*==============================================================================
class BSDismemberSkinInstance +0000 (_vtbl=010C4F64)
0000: class BSDismemberSkinInstance
0000: |   class NiSkinInstance
0000: |   |   class NiObject
0000: |   |   |   class NiRefObject
==============================================================================*/
