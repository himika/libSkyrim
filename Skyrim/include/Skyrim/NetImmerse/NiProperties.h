...
public:
	...
	// @add
	virtual SInt32	GetType(void) = 0;		// 21
	virtual void	Update(float time);		// 22 00ABA700 { for (p = m_controller; p; p = p->next) p->Update(time); }
};
...
/*==============================================================================
class NiShadeProperty +0000 (_vtbl=0111C024)
0000: class NiShadeProperty
0000: |   class NiProperty
0000: |   |   class NiObjectNET
0000: |   |   |   class NiObject
0000: |   |   |   |   class NiRefObject
...
{
public:
	enum { kRTTI = 0x01B92A74 };

	virtual ~NiShadeProperty();

	// @add
	virtual bool	Unk_23(UInt32 arg);			// 00AE81D0 { return true; }
};


/*==============================================================================
class NiFogProperty +0000 (_vtbl=0111C7DC)
0000: class NiFogProperty
0000: |   class NiProperty
0000: |   |   class NiObjectNET
0000: |   |   |   class NiObject
0000: |   |   |   |   class NiRefObject
