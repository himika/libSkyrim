...
public:
	...
	DEFINE_MEMBER_FN(CreateWeaponEnchantment,	EnchantmentItem *,	0x00689D30,	BSTArray<EffectItem> * effectArray);
	DEFINE_MEMBER_FN(CreateArmorEnchantment,	EnchantmentItem *,	0x00689D80,	BSTArray<EffectItem> * effectArray);
	...
	DEFINE_MEMBER_FN(CreatePotion,				void,				0x0068ACB0,	AlchemyItem *& resultPotion, BSTArray<EffectItem> * effectArray);
	DEFINE_MEMBER_FN(CreatePoison,				void,				0x0068AD00,	AlchemyItem *& resultPoison, BSTArray<EffectItem> * effectArray);
