...
public:
	...
	// @add
	virtual UInt32	GetMagicType(void) = 0;				// 00F51EE8 ArchemyItem=7 ScrollItem=0x0D
	virtual void	SetCastType(UInt32 arg);			// 00588F30 { return; }
	virtual UInt32	GetCastType(void) = 0;				// 00F51EE8 ArchemyItem=1
	virtual void	SetDeliveryType(UInt32 arg);		// 00588F30 { return; }
	virtual UInt32	GetDeliveryType(void) = 0;			// 00F51EE8 ArchemyItem=0
	...
	virtual UInt32	Unk_69(void) = 0;					// 00F51EE8 returns char code
