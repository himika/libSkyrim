...
public:
	...
	// @override
	virtual UInt32	GetMagicType(void) override;	// 005C5580 (void) { return kType_Archemy; }
	virtual UInt32	GetCastType(void) override;		// 00CAC8A0 (void) { return 1; }
	virtual UInt32	GetDeliveryType(void) override;	// 005EADD0 (void) { return 0; }
	virtual SInt32	Unk_67(void) override;			// 00DA29A0 (void) { return 0x10; }
	virtual UInt32	Unk_69(void) override;			// 00405A80 (void) { return 'ENIT'; }
	virtual void *	Unk_6D(void) override;			// 00409270 (void) { return &this->itemData; }
	virtual void *	Unk_6E(void) override;			// 00409270 (void) { return &this->itemData; }
	virtual UInt32	Unk_6F(void) override;			// 009B4600 (void) { return sizeof(Data); }
