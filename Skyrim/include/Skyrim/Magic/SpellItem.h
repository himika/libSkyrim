...
public:
	...
	// @override
	virtual UInt32	GetMagicType(void) override;	// 54 0068ED10 { return this->data->type; }
	virtual UInt32	GetCastType(void) override;		// 56 005E22D0 { return this->data->castType; }
	virtual UInt32	GetDeliveryType(void) override;	// 57 00409320 { return this->data->deliveryType; }
	virtual UInt32	GetSigniture(void) override;	// 00409260 { return 'SPIT'; }
	virtual void *	Unk_6D(void) override;			// 00409270 { return &this->data; }
	virtual void *	Unk_6E(void) override;			// 00409270 { return &this->data; }
