...
public:
	...
	float speed() const { return gameData.speed; }
	float reach() const { return gameData.reach; }
	float stagger() const { return gameData.stagger; }
	float minRange() const { return gameData.minRange; }
	float maxRange() const { return gameData.maxRange; }
	UInt8 type() const { return gameData.type; }
	UInt16 critDamage() const { return critData.critDamage; }
