...
public:
	...
	struct Data14
	{
		UInt32		unk00;		// 00 - init'd [01B912CC]
		UInt32		unk04;		// 04 - init'd [01B912D0]
		UInt32		unk08;		// 08 - init'd [01B912CC]
		UInt32		unk0C;		// 0C - init'd [01B912D0]
		UInt32		unk10;		// 10 - init'd [01B912CC]
		UInt32		unk14;		// 14 - init'd [01B912D0]
		UInt32		unk18;		// 18 - init'd [01B912CC]
		UInt32		unk1C;		// 1C - init'd [01B912D0]
		UInt32		unk20;		// 20 - init'd 0 - init'd [0127B934] in PlayerControls::ctor()
		UInt8		autoRun;	// 24
		UInt8		runMode;	// 25
		UInt8		unk26;		// 26
		UInt8		unk27;		// 27
...
private:
	...
	DEFINE_MEMBER_FN(ddd, bool, 0x00771200);
};
